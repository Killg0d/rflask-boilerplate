...
class TaskRouter:
    ...
    def create_route(*,blueprint:Blueprint)->Blueprint:
        ...
        blueprint.add_url_rule("/tasks/<task_id>",view_func=TaskView.as_view("task_update_for_account"),methods=["PATCH"])
        blueprint.add_url_rule("/tasks/<task_id>",view_func=TaskView.as_view("task_delete_for_account"),methods=["DELETE"])
        return blueprint
